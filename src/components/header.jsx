            ...
            <div className="mx-auto px-5 flex justify-between items-center h-16">
                ...
                <div
                    ...
                    <div className="flex flex-col items-center space-y-4 py-4 px-4">
                        ...
                        <a href="#"
                           className="text-white hover:text-blue-300 px-3 py-2 rounded-md text-base font-medium">Home</a>
                        <a href="#about"
                           className="text-white hover:text-blue-300 px-3 py-2 rounded-md text-base font-medium">About</a>
                        <a href="#jobs"
                           className="text-white hover:text-blue-300 px-3 py-2 rounded-md text-base font-medium">Experience</a>
                        <a href="#projects"
                           className="text-white hover:text-blue-300 px-3 py-2 rounded-md text-base font-medium">Projects</a>
                    </div>
                </div>
