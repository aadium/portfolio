                ...
                {projects.map((project) => (
                    <div key={project.id} className="drop-shadow-xl overflow-hidden bg-white rounded-lg">
                        <div className="py-6 px-10 text-gray-800 flex flex-col justify-evenly">
                            ...
                            <button
                                className="my-1 text-base rounded-lg text-white w-fit font-semibold bg-gray-800 px-4 py-2 hover:bg-transparent hover:text-gray-800 hover:ring-inset hover:ring-2 ring-gray-800 transition duration-150">
